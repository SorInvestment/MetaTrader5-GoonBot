...
_RELOADABLE_KEYS = {
    ...
    "SCALE_OUT_AT_R", "SCALE_OUT_PCT", "USE_MULTI_TP",
    "NEWS_FILTER_ENABLED", "NEWS_BUFFER_MINUTES", "NEWS_POST_BUFFER_MINUTES",
    "NEWS_CACHE_HOURS", "LOSING_STREAK_THRESHOLD",
    "STREAK_RISK_REDUCTION", "MAX_CONSECUTIVE_LOSSES",
    "CIRCUIT_BREAKER_COOLDOWN_HOURS", "SYMBOL_DAILY_LOSS_LIMIT_PCT",
    "USE_LIMIT_ORDERS", "LIMIT_ORDER_SCORE_THRESHOLD", "LIMIT_ORDER_EXPIRY_BARS",
